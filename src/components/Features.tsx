...
export default function Features() {
  return (
    <section id="features" className="relative overflow-hidden py-24">
      {/* Dark cosmic-dream backdrop — warm planet glow + violet/magenta nebula
          to match the hero reveal (no cool blues). */}
      <div className="pointer-events-none absolute inset-0">
        <div className="absolute inset-0 bg-gradient-to-b from-[#0c0a18] via-[#160f2e] to-[#0c0a18]" />
        {/* violet nebula */}
        <div className="absolute -top-24 left-1/4 h-[460px] w-[460px] -translate-x-1/2 rounded-full bg-[#7c3aed]/25 blur-[150px]" />
        {/* warm golden planet-glow */}
        <div className="absolute top-1/4 right-[12%] h-[420px] w-[420px] rounded-full bg-[#e8902a]/18 blur-[150px]" />
        {/* deep magenta */}
        <div className="absolute -bottom-24 left-[18%] h-[400px] w-[400px] rounded-full bg-[#a21caf]/16 blur-[160px]" />
